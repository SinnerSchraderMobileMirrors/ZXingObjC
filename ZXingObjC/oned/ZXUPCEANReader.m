...
#define MAX_AVG_VARIANCE (int)(ZX_ONED_PATTERN_MATCH_RESULT_SCALE_FACTOR * 0.48f)
#define MAX_INDIVIDUAL_VARIANCE (int)(ZX_ONED_PATTERN_MATCH_RESULT_SCALE_FACTOR * 0.7f)
